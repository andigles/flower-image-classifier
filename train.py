...
def main():
    ...
    trainloader, validloader, testloader, class_to_idx = helper.data_batching(in_arg.data_dir)
    ...
    trained_model, optimizer_state_dict = helper.training_classifier(model, trainloader, validloader, testloader, in_arg.learning_rate, in_arg.epochs, in_arg.gpu)
    ...
    helper.saving_model(in_arg.save_dir, class_to_idx, trained_model, optimizer_state_dict, in_arg.arch, in_arg.learning_rate, in_arg.hidden_units, in_arg.dropout, in_arg.epochs)
